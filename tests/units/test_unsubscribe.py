...
def pubpen_multi_callback(event_loop):
    ...
    pubpen._event_handlers['test_event1'].add((0, 'handler1'))
    pubpen._event_handlers['test_event1'].add((1, 'handler2'))
    pubpen._event_handlers['test_event1'].add((2, 'handler3'))
...
class TestPubPenUnsubscribe:
    ...
    def test_unsubscribe_multi_event_remove_first(self, pubpen_multi_event):
        ...
        assert (1, 'handler2') in pubpen_multi_event._event_handlers['test_event2']
    ...
    def test_unsubscribe_multi_event_remove_last(self, pubpen_multi_event):
        ...
        assert (0, 'handler1') in pubpen_multi_event._event_handlers['test_event1']
    ...
    def test_unsubscribe_multi_callback_remove_first(self, pubpen_multi_callback):
        ...
        assert (2, 'handler3') in pubpen_multi_callback._event_handlers['test_event1']
